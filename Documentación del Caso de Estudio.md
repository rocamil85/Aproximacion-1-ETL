...
Para este Caso de Estudio particular la aproximación utilizada ETL con Cloud Composer orquestando todos los procesos no es costo/eficiente por lo que se procede a analizar una nueva alternativa arquitectónica de tipo ELT. **(Ver Caso de Estudio 2 Aproximación  ELT)**.
